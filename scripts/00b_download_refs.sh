...
# Download cds, gff, and genome seq for A. baylyi ADP1 GCF_000046845.1
datasets download genome accession GCF_000046845.1 --include cds,gff3,genome \
...
mv ncbi_dataset/data/GCF_000046845.1/*_genomic.fna ./a-baylyi_genome.fa

rm -r ncbi_dataset
rm a-baylyi_refs.zip

# Download cds, gff, and genome seq for M. aeruginosa LE3 (UTEX 3037) GCF_032701645.1
datasets download genome accession GCF_032701645.1 --include cds,gff3,genome \
...
mv ncbi_dataset/data/GCF_032701645.1/*_genomic.fna ./m-aeruginosa_genome.fa
